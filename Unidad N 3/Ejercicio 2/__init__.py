...
correspondientes. 
b- Definir un GestorMaterial, que permita almacenar los materiales. El gestor debe 
basarse en una lista del lenguaje Python. 
c- Definir un GestorLadrillo, que permita almacenar los ladrillos. El gestor debe basarse 
